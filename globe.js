...
function FsGlobe() {
  ...
  const e = document.querySelector("[fs-3dglobe-element='container']"),
    t = {
      url:
        e.getAttribute("fs-3dglobe-img") ||
        "https://cdn.finsweet.com/files/globe/earthmap1k.jpg"
    },
  ...
  (s.enableDamping = !0),
    ...
    (s.maxDistance = 4),
    (s.autoRotate = !0),
    (s.domElement.focus = null),
    (s.autoRotateSpeed = 0.1),
    s.target.set(0, 0, 0),
    r.position.set(2.5, 0, 0),
    (s.enableZoom = !1),
    s.update();
  ...
  //white bottom light
  var pointLight3 = new THREE.DirectionalLight(3355443, 3);
  pointLight3.position.set(10, -5, 1);
  //cyan top light
  var pointLight4 = new THREE.DirectionalLight(0x47329f, 1);
  pointLight4.position.set(-1, 4, -1);
  //blue right light
  var pointLight = new THREE.DirectionalLight(4668144, 4);
  pointLight.position.set(10, 4, -2);
  //teal left light
  var pointLight2 = new THREE.DirectionalLight(0x47329f, 2);
    ...
    (function () {
      ...
      for (const [n, d] of m.entries()) {
        ...
        if (((g.className = "fs-3dglobe-arrow-box"), a[n])) g.appendChild(a[n]);
          ...
          (t.className = "logo_dot"),
            (t.position = "relative"),
            t.setAttribute("alt", m),
    ...
    s.update(),
      (function () {
        ...
        for (const t of m) {
          ...
          (l.style.transform = `translate(-50%, -50%) translate(${i}px,${s}px)`),
